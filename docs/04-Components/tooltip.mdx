...
import { Badge, InfoBox, Icon } from '@grafana/ui';

# Tooltip <Badge text='ready' color='green'></Badge> <a href='https://developers.grafana.com/ui/latest/index.html?path=/story/overlays-tooltip--basic' target='_blank' className='header-links'>Storybook <Icon name="external-link-alt"/> </a>
...
<iframe
  src="https://developers.grafana.com/ui/latest/index.html?path=/story/overlays-tooltip--basic&full=1&shortcuts=false&singleStory=true"
  width="100%"
  height="500px"
></iframe>
...
### Anatomy
![Image calling out parts of the tooltip](/img/tooltip_anatomy.png 'Image calling out parts of the tooltip')
