...
![button emphasis](/static/img/button_emphasis.png 'Visual representation of button emphasis')
...
### Anatomy
![Image description](/static/img/button_anatomy.png 'Visual representation of button anatomy')
...
![button sizes](/static/img/button_sizes.png 'Visual representation of button sizes')
