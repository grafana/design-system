...
Saving within Grafana is a multi-tiered pattern that varies depending on the required amount of friction (see: [Design Principle: Tasteful Friction](/design/Foundations/design-principles#tasteful-friction)) and importance of the item being saved.
