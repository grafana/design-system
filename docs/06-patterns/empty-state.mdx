...
# Empty State <Badge text='draft' color='orange'></Badge> <a href='https://developers.grafana.com/ui/latest/index.html?path=/story/general-emptystate--basic' target='_blank' className='header-links'>Storybook <Icon name="external-link-alt"/> </a>
...
There is an `EmptyState` component with different variants to handle the most common empty state use cases. These variants provide a specific default message and image.
