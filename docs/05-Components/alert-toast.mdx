...
# Toast <Badge text='ready' color='green'></Badge> <a href='https://developers.grafana.com/ui/latest/index.html?path=/story/overlays-alert--examples' target='_blank' className='header-links'>Storybook <Icon name="external-link-alt"/> </a>
...
![Do](/img/toast-do-description-details.png) 
...
![Dont](/img/toast-dont-description-details.png)
...
![Do](/img/toast-do-body-style.png) 
...
![Dont](/img/toast-dont-body-style.png)

Do not use a title style for the message.
...
![Image description](/img/toast-placement.png 'Visual representation of toast')

1. Second toast displayed
2. First toast displayed
