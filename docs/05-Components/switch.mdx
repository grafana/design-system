...
# Switch <Badge text='ready' color='green'></Badge> <a href='https://developers.grafana.com/ui/canary/index.html?path=/story/forms-switch--controlled' target='_blank' className='header-links'>Storybook <Icon name="external-link-alt"/> </a>

The `Switch` component is used to toggle between two states, typically representing an on/off or enabled/disabled state.

<iframe
    src="https://developers.grafana.com/ui/canary/index.html?path=/story/forms-switch--controlled"
    width="100%"
    height="300px"
></iframe>
