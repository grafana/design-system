...
# Text <Badge text='ready' color='green'></Badge> <a href='https://developers.grafana.com/ui/canary/index.html?path=/docs/general-text--docs' target='_blank' className='header-links'>Storybook <Icon name="external-link-alt"/> </a>

The Text component can be used to apply typography styles in a simple way, without the need of extra css.

<iframe
  src="https://developers.grafana.com/ui/canary/index.html?path=/story/general-text--basic&full=1&shortcuts=false&singleStory=true"
  width="100%"
  height="300px"
></iframe>
